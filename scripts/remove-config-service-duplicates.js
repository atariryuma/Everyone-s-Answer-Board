...
/**
 * Remove duplicate API functions from ConfigService.gs
...
function main() {
  const filePath = path.join(__dirname, '../src/ConfigService.gs');
  ...
  try {
    ...
    console.log(`✅ Successfully removed ${FUNCTIONS_TO_REMOVE.length} duplicate API functions from ConfigService.gs`);
